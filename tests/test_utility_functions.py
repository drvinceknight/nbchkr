...
def test_get_tags_with_given_regex():
    ...
    assert nbchkr.utils.get_tags(cell=cell, tag_seperator="@", tag_regex=nbchkr.utils.ANSWER_TAG_REGEX) == "answer:q1@answer:q2"
    assert nbchkr.utils.get_tags(cell=cell, tag_regex=nbchkr.utils.ANSWER_TAG_REGEX) == "answer:q1|answer:q2"
